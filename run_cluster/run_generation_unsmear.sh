...
g++ py8_main_nosmear.cc -o py8_main_unsmear -I$MG5_PATH/HEPTools/pythia8//include -ldl -fPIC -lstdc++ -std=c++11 -O2 -DHEPMC2HACK -DGZIP -I$MG5_PATH/HEPTools/zlib/include -L$MG5_PATH/HEPTools/zlib/lib -Wl,-rpath,$MG5_PATH/HEPTools/zlib/lib -lz -L$MG5_PATH/HEPTools/pythia8//lib -Wl,-rpath,$MG5_PATH/HEPTools/pythia8//lib -lpythia8 -ldl -I$MG5_PATH/HEPTools/hepmc/include -L$MG5_PATH/HEPTools/hepmc/lib -Wl,-rpath,$MG5_PATH/HEPTools/hepmc/lib -lHepMC -DHEPMC2
...
cp  events_delphes_${TAG}.root /eos/user/f/fdibello/BigBello/data_py_unsmear/events_delphes_${TAG}.root


ls -l /eos/user/f/fdibello/BigBello/data_py_unsmear/

cd /afs/cern.ch/work/f/fdibello/ChrisMalte/delphes/

root -l -b -q "makeNtuples.C(\"/eos/user/f/fdibello/BigBello/data_py_unsmear/events_delphes_${TAG}.root\",\"/eos/user/f/fdibello/BigBello/data_py_unsmear/output_QCD_PSmurr2_smeared_${TAG}.root\")" 

cd -

#rm  /eos/user/f/fdibello/BigBello/data_py_unsmear/events_delphes_${TAG}.root
